...
public partial class MainWindow : Window
{
    ...
    {
        if (_services.Settings.Value.UiAnimationsEnabled)
        {
            Opacity = 0;
    ...
    {
        var appliedPercent = _services.UiScale.Apply(DesignSurface, this, 1600, 900);
    ...
    private void Window_Closing(object? sender, CancelEventArgs e)
    {
        ...
        _services.UiScale.ScaleChanged -= UiScale_ScaleChanged;
        var settings = _services.Settings.Value;
        settings.MainLeftColumnWidth = MainRightColumn.ActualWidth > 0 ? Math.Clamp(MainLeftColumn.ActualWidth / MainRightColumn.ActualWidth, 0.25, 6) : 1.04;
        settings.MainTopRowHeight = MainBottomRow.ActualHeight > 0 ? Math.Clamp(MainTopRow.ActualHeight / MainBottomRow.ActualHeight, 0.25, 6) : 1.13;
