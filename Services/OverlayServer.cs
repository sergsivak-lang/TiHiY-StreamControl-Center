...
""";
    ...
    private static string ThemeCss(string theme)
    {
        ...
        if (key.Contains("cyber amber")) return ".msg,#card{background:rgba(3,13,22,.84);border:1px solid rgba(39,217,255,.34);border-left:4px solid #ffaa00;box-shadow:0 0 18px rgba(255,170,0,.22)}.platformIcon{box-shadow:0 0 9px rgba(255,170,0,.42)}.fill{background:#ffaa00}";
        if (key.Contains("cyber blue")) return ".msg,#card{background:rgba(4,17,27,.84);border:1px solid rgba(51,216,255,.42);border-left:4px solid #168dff;box-shadow:0 0 18px rgba(22,141,255,.22)}.platformIcon{box-shadow:0 0 9px rgba(51,216,255,.45)}.fill{background:#168dff}";
        if (key.Contains("emerald")) return ".msg,#card{background:rgba(4,20,15,.84);border:1px solid rgba(57,230,208,.36);border-left:4px solid #00c878;box-shadow:0 0 18px rgba(0,200,120,.22)}.platformIcon{box-shadow:0 0 9px rgba(0,200,120,.44)}.fill{background:#00c878}";
        if (key.Contains("purple")) return ".msg,#card{background:rgba(16,9,26,.86);border:1px solid rgba(143,232,255,.32);border-left:4px solid #b35cff;box-shadow:0 0 18px rgba(179,92,255,.24)}.platformIcon{box-shadow:0 0 9px rgba(179,92,255,.46)}.fill{background:#b35cff}";
        if (key.Contains("minimal dark")) return ".msg,#card{background:rgba(15,19,23,.70);border:1px solid rgba(127,147,163,.30);border-left:3px solid #7f93a3;box-shadow:none}.platformIcon{box-shadow:none}.fill{background:#7f93a3}";
